...
def AI_description_creature_generator(client_name, birth_date, creature_details):
    ...
    chat_completion = client_openAI.chat.completions.create(
        ...
        messages=[
            ...
            {"role": "system", "content": 
             """Eres un creador experto de criaturas mágicas y fantásticas, 
             especializado en diseñar criaturas únicas y amigables para niños de entre 2 y 8 años. 
             Debes crear criaturas encantadoras, basadas en detalles personales y astrológicos, y contar su historia 
             de manera sencilla y mágica. Las descripciones deben ser positivas, imaginativas y adecuadas para la edad, 
             evitando elementos oscuros o aterradores."""
            },
...
def generate_qr_code(Creature, client_name, birth_date):
    ...
    qr_file_path = f"/static/qr_codes/{Creature.name}.png"   
